...
function Contact() {
    ...
    const handleSendMessage = () => {
        ...
        const whatsappLink = `https://wa.me/${+995577224831}?text=${encodeURIComponent(formattedMessage)}`;
    ...
    return (
        <AnimatePresence>
            {/* {isHideContact && ( */}
            <div className="bg-gradient-to-b from-[#20095F] to-[#130538] min-h-screen relative overflow-hidden pb-[150px]" id='contact'>
                {/* contact name */}
