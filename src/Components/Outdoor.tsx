    ...
    return (
        isHideOutdoor && (
            <div className="fixed inset-0 z-10 flex items-center justify-center" id="sign">
                <div className="absolute inset-0 bg-black/20 backdrop-blur-[0.1px] grayscale-[100%]" onClick={() => setIsHideOutdoor(!isHideOutdoor)}></div>
                ...
                <div className="bg-[#1E222C] text-white rounded-lg shadow-lg w-[400px] max-w-[90%] p-6 relative z-10">
                    ...
                    <h2 className="mb-2 text-[18px] font-semibold" id="login-text">LOGIN TO USE THE OUTDOOR</h2>
